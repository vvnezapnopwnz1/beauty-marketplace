...
export interface SalonProfile {
  ...
  /** @deprecated Legacy; API may still return it. Do not send from profile UI — use salonCategoryScopes. */
  salonType?: string | null
  /** @deprecated Legacy venue/individual; API may still return it. Do not send from profile UI. */
