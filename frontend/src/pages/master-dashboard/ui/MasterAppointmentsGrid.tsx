    ...
    () =>
      [
          ...
          renderCell: ({ row }) => (
            <Box display="flex" flexDirection="row" alignItems="center" gap={0.5}>
              ...
              >
                ...
                {row.clientPhone && (
                  <Box sx={{ fontSize: 10, color: d.muted }}>{row.clientPhone}</Box>
                )}
              </Box>
            </Box>
          ),
        ...
        },
        {
          ...
          sortable: false,
          renderCell: ({ row }) => (
            <Box sx={{ fontSize: 12, fontWeight: 600, color: d.text }}>
              {formatCurrency(row.totalPriceCents ?? 0)}
            </Box>
          ),
        },
        {
