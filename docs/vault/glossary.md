...
| **mass schedule** | Массовое расписание: единый шаблон рабочих часов мастера для выбранных дней недели. |
| **individual schedule** | Индивидуальное расписание: индивидуальные рабочие интервалы и выходные для каждого дня недели отдельно. |
| **contact masking** | Маскировка контактных данных (телефонов, мессенджеров, соцсетей) в чатах во избежание обхода платформы. |
| **app lock** | Биометрическая блокировка мобильного приложения по отпечатку пальца / лицу (через FaceID/TouchID) при простое. |
