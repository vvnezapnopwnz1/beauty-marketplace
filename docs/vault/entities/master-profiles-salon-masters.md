...
- Настройка личного расписания (**`master_hours`**) в двух режимах:
  - *Массовое редактирование:* применение единых рабочих часов для выбранного набора дней недели (с поддержкой быстрых временных пресетов).
  - *Индивидуальное редактирование:* индивидуальное распределение рабочих интервалов по каждому конкретному дню недели и гибкое переключение выходных.
